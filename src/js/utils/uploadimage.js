...
function getUserPhoto(DOM, CB) {
    ...
    function bind() {
        ...
        $("#uploader").change(function() {
            ...
            reader.onload = function(e) {
                ...
                mpImg.render(resetImage, { maxWidth: 700, maxHeight: 700, orientation: 1 })
                //let getImgR = ori_tpy;
    ...
    this.init = function() {
        ...
        DOM.append(`            
            <img class="img-responsive" src="#" id="preview_img_reset" alt="empty preview">
            `);
        bind();
    }
    this.init();
