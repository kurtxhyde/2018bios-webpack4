...
class particleSyetem {
    ...
    var r = (window.innerWidth > window.innerHeight)? window.innerWidth *1.5: window.innerHeight*1.5;
    var rHalf = r / 2;
    ...
    function init() {
       ...
       // camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 1, 4000);
        ...
        let sprite= new THREE.TextureLoader().load( "img/dest/spark.png" );
...
setAnimRotate(from,to , t=1){
    const group = this.group;
    if(from){
        TweenMax.fromTo(group.rotation ,t , {y:from},{delay:0,y:to,ease:Expo.easeOut}) 
    }else{
        TweenMax.to(group.rotation ,t ,{delay:0,y:to,ease:Expo.easeOut}) 
    }
}
...
export {
    particleSyetem as particleSyetem
}